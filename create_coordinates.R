##################################################################
#
# This script contains a function that creates the coordinates
# to extract from the PDF.
#
# The function has no parameters. But, is used so that we are 
# only returning the coordinte values as object, and not other
# objects used to create the coordinates.
#
# only need to run extract_coordinates function!!
##################################################################
